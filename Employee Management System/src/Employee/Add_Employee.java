...
class Add_Employee implements ActionListener{
    ...
    Add_Employee(){
        ...
        id15=new JLabel();
        id15.setBounds(0,0,900,720);
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee/icons/update.png"));
        id15.setIcon(img);

        id8 = new JLabel("New Employee Details");
        id8.setBounds(230,30,500,50);
        id8.setFont(new Font("Tahoma",Font.BOLD,40));
        ...
        id1.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id1);
        ...
        id2.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id2);
        ...
        id3.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id3);
        ...
        id4.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id4);
        ...
        id5.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id5);
        ...
        id6.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id6);
        ...
        id7.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id7);
        ...
        id9.setFont(new Font("Tahoma",Font.BOLD,20));    
        id15.add(id9);
        ...
        id10.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id10);
        ...
        id11.setBounds(400,350,120,30);
        id11.setForeground(Color.white);
        id11.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id11);
        ...
        id12.setFont(new Font("Tahoma",Font.BOLD,20));
        id15.add(id12);
